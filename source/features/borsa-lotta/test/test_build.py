"""Contratti del bundle e della prenotazione della Borsa in battaglia."""
import copy
import hashlib
import json
...
from sgp12.blocchi import borsa_lotta
...
class TestBuild(unittest.TestCase):
    def test_bundle_spedito_conforme(self):
        man, block = borsa_lotta._carica_build(BUILD)
    ...
    def test_blob_manomesso_rifiutato(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            with self.assertRaises(Rifiuto):
                borsa_lotta._carica_build(folder)
    ...
    def test_simbolo_fuori_blocco_rifiutato(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            man['simboli']['sgp_borsa_attr_hook'] = '0x023dc001'
