...
Everything here rebuilds and checks the game from **your own** game file. No game file is distributed, and none is needed to run the tests that CI runs. For the branching model, the release cycle and the two classes of test, read [DEVELOPMENT.md](../DEVELOPMENT.md).
...
It is not redistributed here; see [CREDITS.md](../CREDITS.md) for why.
