...
Sacred Gold Plus builds on Drayano's Sacred Gold, a HeartGold hack. The notes below summarize the original author's **1.03 documentation**. They describe the game we started from; our own 1.04 changes are listed separately in the [changelog](CHANGELOG.md).
